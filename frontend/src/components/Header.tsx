    ...
    <header>
      <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
        <div className="container _custom_container">
          ...
          <button className="navbar-toggler bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"> <span className="navbar-toggler-icon"></span>
          </button>
          {/* removed `collapse` class to ensure items are visible on first render; keeping `navbar-collapse` for layout */}
          <div className="navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="_header_nav_profile" style={{ position: "relative" }}>
              ...
              {/* small profile dropdown displayed when profileOpen is true */}
              {profileOpen && (
                <div
                  className="_profile_dropdown_box _b_radious6 _shadow_sm"
                  style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, minWidth: 220, zIndex: 1200 }}
                >
                  ...
                  <ul className="_profile_dropdown_list">
                    <li>
                      <a href="/profile" className="_profile_dropdown_item">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="_profile_dropdown_icon">
                          <path d="M8 8a3 3 0 100-6 3 3 0 000 6z" stroke="#112032" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M2.5 14s1.5-3 5.5-3 5.5 3 5.5 3" stroke="#112032" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <span>My Profile</span>
                      </a>
                    </li>
                    <li>
                      <a href="/settings" className="_profile_dropdown_item">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="_profile_dropdown_icon">
                          <path d="M12 15.5a3.5 3.5 0 100-7 3.5 3.5 0 000 7z" stroke="#112032" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09a1.65 1.65 0 00-1-1.51 1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09a1.65 1.65 0 001.51-1 1.65 1.65 0 00-.33-1.82L4.21 6.5a2 2 0 012.83-2.83l.06.06a1.65 1.65 0 001.82.33H11a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09c.2.6.68 1.07 1.28 1.28.59.2 1.19.03 1.51-1h.09a2 2 0 012 2v.09c0 .66-.3 1.27-.79 1.68z" stroke="#112032" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <span>Settings</span>
                      </a>
                    </li>
                    <li>
                      <a href="/help" className="_profile_dropdown_item">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="_profile_dropdown_icon">
                          <path d="M12 2a10 10 0 100 20 10 10 0 000-20z" stroke="#112032" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M9.09 9a3 3 0 115.82 1c0 2-3 2.5-3 2.5" stroke="#112032" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M12 17h.01" stroke="#112032" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
